<div style="position:relative;">
    ...
    <div class="card w-100 shadow-1-strong rounded-3 mb-4">
        <div class="card-body p-4 m-4">
            ...
            <input id="image" wire:change="$emit('fileChoosen')" name="image" class="d-none" type="file">
                ...
                <div class="form-group">
                    <button @error('comment') disabled @enderror wire:loading.attr='disabled' wire:target='addComment'
                        ...
                        <span wire:target='addComment' wire:loading.class.remove='d-none'
                            class="d-none spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                        submit
                    </button>
                </div>
            </form>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex ">
                        ...
                        <button wire:click="remove({{ $comment->id }})"
                            class="shadow-0 btn btn-white ml-2 btn-floating btn-sm">
